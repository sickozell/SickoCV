...
**Miscellaneous**  
If the first track recorded is unsynced, tempo will be automatically detected and bpm knob set according also to measure knob. In this case metronome is reset if internal clock is used.
