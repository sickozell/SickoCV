...
struct Btoggler8PlusWidget : ModuleWidget {
	Btoggler8PlusWidget(Btoggler8Plus* module) {
		setModule(module);
		setPanel(createPanel(asset::plugin(pluginInstance, "res/Btoggler8Plus.svg")));
		...
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.7, 21)), module, Btoggler8Plus::CLOCK_INPUT));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(20.8, 21)), module, Btoggler8Plus::FADE_PARAMS));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(39.2, 17)), module, Btoggler8Plus::WARNIN_PARAMS));
		addParam(createParamCentered<Trimpot>(mm2px(Vec(39.2, 25)), module, Btoggler8Plus::WARNOUT_PARAMS));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(49.2, 21)), module, Btoggler8Plus::RSTALL_INPUT));

		float x = 8.9f;
		float y = 10.5f;
		for (int i=0;i<8;i++) {
			addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.7, 42+(i*y))), module, Btoggler8Plus::ARM_INPUT+i));
			addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.7+x, 42+(i*y))), module, Btoggler8Plus::IN_INPUT+i));
			addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(5.7+(2*x), 42+(i*y))), module, Btoggler8Plus::OUT_OUTPUT+i));
			addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(5.7+(3*x), 42+(i*y))), module, Btoggler8Plus::GATE_OUTPUT+i));
			addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(5.7+(4*x), 42+(i*y))), module, Btoggler8Plus::WARN_OUTPUT+i));
			addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.7+(5*x), 42+(i*y))), module, Btoggler8Plus::RST_INPUT+i));
		}
	}
};


Model* modelBtoggler8Plus = createModel<Btoggler8Plus, Btoggler8PlusWidget>("Btoggler8Plus");