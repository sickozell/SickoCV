...
struct BtogglerStWidget : ModuleWidget {
	BtogglerStWidget(BtogglerSt* module) {
		...
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(16.5, 108.8)), module, BtogglerSt::RIN_INPUT));

		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(29, 103.2)), module, BtogglerSt::OUT_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(39.2, 103.2)), module, BtogglerSt::ROUT_OUTPUT));
