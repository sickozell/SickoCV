...
struct TogglerWidget : ModuleWidget {
	TogglerWidget(Toggler* module) {
		...
		addParam(createParamCentered<CKSS>(mm2px(Vec(4, 11.2)), module, Toggler::MODE_SWITCH));

		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.16, 24.5)), module, Toggler::TRIG_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.16, 36.2)), module, Toggler::RST_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.2, 52.8)), module, Toggler::IN_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(14.5, 52.8)), module, Toggler::RIN_INPUT));

		addParam(createParamCentered<Trimpot>(mm2px(Vec(6.32, 62)), module, Toggler::ATTACK_PARAMS));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.32, 69)), module, Toggler::ATTACK_INPUT));

		addParam(createParamCentered<Trimpot>(mm2px(Vec(14.32, 73)), module, Toggler::SUSTAIN_PARAMS));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(14.32, 80)), module, Toggler::SUSTAIN_INPUT));

		addParam(createParamCentered<Trimpot>(mm2px(Vec(6.32, 84)), module, Toggler::RELEASE_PARAMS));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(6.32, 91)), module, Toggler::RELEASE_INPUT));


		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(6.2, 107.5)), module, Toggler::OUT_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(14.5, 107.5)), module, Toggler::ROUT_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(10.16, 119)), module, Toggler::GATE_OUTPUT));
	}
};
