...
struct DrumPlayerInitializeUserFolder : MenuItem {
	DrumPlayer *rm ;
...
struct DrumPlayerWidget : ModuleWidget {
	...
	void appendContextMenu(Menu *menu) override {
		...
		DrumPlayerInitializeUserFolder *rootFolder = new DrumPlayerInitializeUserFolder;
